...
public class CrimeFragment extends Fragment {
    ...
    //Used as an unique identifier for the dialog fragment.
    //It will be used to ensure that the fragment manager knows which fragment we are trying to use.
    private static final String DIALOG_DATE = "DialogDate";



    //Setup a request code that will be used when sending the result of the dialog to the
    //onActivityResult. We want onActivityResult to know that it is coming from the result of the dialog
    //and not some other activity. That's why we need this code.
...
//**********************************************************************************
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
       ...
       // mDateButton.setEnabled(false);
        ...
        //Set up an onclick listener for the date button
        mDateButton.setOnClickListener(new View.OnClickListener(){
            @Override
                ...
                //Create a new version of the date picker fragment that can be used to show the dialog.
                //DatePickerFragment dialog = new DatePickerFragment();
                //------------------------------------------------------------------------------------------
                //Ask the DatePickerFragment class to supply us with a new fragment that can be used to show the dialog
                //The newInstance method requires that we pass a date, and so we send it te crime date.
                //We wrote this method in the DatePickerFragment class.
                DatePickerFragment dialog = DatePickerFragment.newInstance(mCrime.getDate());

                //Tell the dialog what it's return target is.
                //We know that this dialog will return to the CrimeFragment,
                //and so that is what we are telling it.
                //We also pass a request code that is declared at the top of this class.
